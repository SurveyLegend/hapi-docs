<template>
    <main class="main h-position-relative">
        <div class="main__content h-position-relative">
            ...
            <p>This example API documentation page was created with <a class="h-text-underline" href="https://github.com/SurveyLegend/hapi-slate">Hapi Slate</a>. Feel free to edit it and use it as a base for your own API's documentation.</p>

            <h1 id="authentication">Authentication</h1>
            <p>Kittn uses API keys to allow access to the API. You can register a new Kittn API key at our <a class="h-text-underline" href="http://example.com/developers">developer portal</a>.</p>
            ...
            <notice type="info">You must replace <code>meowmeowmeow</code> with your personal API key.</notice>
            ...
            <notice type="error">Inside HTML code blocks like this one, you can't use Markdown, so use <code>&lt;code&gt;</code> blocks to denote code.</notice>

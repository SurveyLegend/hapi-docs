...
const plugin = {
    ...
    async register(server, options) {
        let settings = Hoek.applyToDefaults(internals.defaults, options, { nullOverride: true })
        ...
        // Hapi v19+ should be '@hapi/inert' and older than v19 should be only 'inert' even if @hapi/inert is imported
        await server.dependency((server.version.startsWith('19') ? '@hapi/' : '') + 'inert')
